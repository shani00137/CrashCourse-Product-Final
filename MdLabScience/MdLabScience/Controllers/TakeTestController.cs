...
namespace EMCQWebApi.Controllers
{
    public class TakeTestController : ApiController
    {
        ...
        public IHttpActionResult PrepareTest([FromBody] AppUserTestModel value)
        {
            String _response = "";
        ...
        public IHttpActionResult GetTestHistory(int AppUserId)
        {
        ...
        public IHttpActionResult GetAppUserTest()
        {
            List<AppUserTestModel> list = new List<AppUserTestModel>();
            using (MdLabScienceDbEntities db = new MdLabScienceDbEntities())
            {
        ...
        public IHttpActionResult GetTestDetails(int testId)
        {
            using (MdLabScienceDbEntities db = new MdLabScienceDbEntities())
            {
        ...
        public IHttpActionResult GetTestSummary(int id)
        {
                ...
                if (QuestionCount.Count > 0)
                {
                    ...
                    foreach (var q in QuestionQuery)
                    {
                        ...
                        foreach (var w in q.QuestionOptions)
                        {
                            ...
                            //dt.Rows[RowIndex]["RightOption"] = w.IsRightAns==true? OpIndex:0;
        ...
        public IHttpActionResult TakeTestByUser(int id)
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("TestId");
            dt.Columns.Add("QuestionId", typeof(int));
        ...
        public IHttpActionResult SaveTest(int testId)
        {
            int RightAnswers = 0;
            using (MdLabScienceDbEntities db = new MdLabScienceDbEntities())
            {
                ...
                if (Query != null)
                {
                    ...
                    //Query.Remarks = ExamPerformance.GetRemarks(20 ,10);
                    db.SaveChanges();
                    
                }
                return Json("Submit Sucessfuly..");
            }
        }

        [HttpGet]
        [Route("api/TakeTest/GetAppUserTestResult/{AppUserId}")]
        public IHttpActionResult GetAppUserTestResult(int AppUserId)
        {
            ...
            using (MdLabScienceDbEntities db = new MdLabScienceDbEntities())
            {
                ...
                //foreach (var q in QuestionQuery)
                //{
                //    var Result = db.TestQuestionOptionTbs.Where(x => x.TestId == q.TestId).ToList();

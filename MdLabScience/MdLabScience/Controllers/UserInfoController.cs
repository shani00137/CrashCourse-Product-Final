...
namespace IMS_WebApp.Controllers
{
    public class UserInfoController : ApiController
    {
        ...
        public IHttpActionResult GetUsersInfoWithEMP()
        {
            ...
            try
            {
                ...
                if (CheckQueryforName.Count == 0)
                {
                    ...
                    if (valid == true)
                    {
                        ...
                        //userInfo.ExpireDate = Convert.ToDateTime(userInfoMD.ExpireDate).Date;
        ...
        public string Edit([FromBody] UserInofMD value)
        {
            ...
            if (query.Count > 0)
            {
                ...
                //query[0].ExpireDate = Convert.ToDateTime(value.ExpireDate);

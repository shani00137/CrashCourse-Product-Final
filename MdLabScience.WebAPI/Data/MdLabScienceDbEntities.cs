...
namespace MdLabScience.DbContext
{
    public class MdLabScienceDbEntities : Microsoft.EntityFrameworkCore.DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApplicantStatusTransactionsTb>(entity =>
            {
                entity.HasKey(e => e.StatusTransactionId);
                entity.ToTable("ApplicantStatusTransactionsTb");
            });
            ...
            modelBuilder.Entity<UserReadingTimeTb>(entity =>
            {

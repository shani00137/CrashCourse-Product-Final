...
import {
  Plus, Search, X, Eye, Edit2, Trash2, ChevronLeft, ChevronRight,
  AlertCircle, Users, CheckCircle,
} from "lucide-react";
import { Btn, BouncingDots, Card, Avatar, StatusBadge, SearchableSelect } from "../../shared/ui";
import {
  getApplicants, getCountries, getActiveCourses,
  type Applicant, type Country, type Course,
} from "../../../../services/applicantService";

type Screen = "applicants" | "applicant-detail" | "registration";

export function ApplicantsScreen({ setScreen, onSelectApplicant, onEditApplicant, onAddApplicant }: {

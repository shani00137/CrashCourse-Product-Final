      ...
      <div className="grid grid-cols-3 gap-4">
        {screenshots.map(s => (
          <Card key={s.id} className="overflow-hidden cursor-pointer group" onClick={() => setLightbox(s.id)}>
            <div className="bg-gradient-to-br from-red-100 to-red-50 h-36 flex items-center justify-center relative">
              <Camera size={28} className="text-red-300 group-hover:text-red-500 transition" />
